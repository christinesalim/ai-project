...
#Because this code is outside any function it will run once
...
@app.get(
    ...
    response_description="A JSON record with a message i it. If the API is running the message will say successful.",
...
@app.post("/predict/",
          ...
          response_description="""A JSON record with three predicted amounts. 
...
def predict (features: FantasyAcquisitionFeatures):
    ...
    #Return the prediction as a Pydantic model
